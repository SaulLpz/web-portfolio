...
const Technologies = () => {
  return (
    <div className="col-span-12 md:col-span-6 bg-indigo-200 rounded-3xl flex justify-center items-center backdrop-filter bg-opacity-20">
        <div className="w-full h-full grid grid-rows-3 grid-cols-4 lg:grid-rows-2 lg:grid-cols-6 text-white text-base xl:text-lg font-semibold lg:font-bold justify-center items-center">
        {
